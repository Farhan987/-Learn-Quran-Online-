...
export const getTeacherFriendsProfile1 = studentId => dispatch => {
  axios
...
export const createNewGroup = (
  ...
  axios
    ...
    .then(res => {
      ...
      context.setState({ flag: true, spinnerMove: false });
    })
    .catch(err => {
      console.log(err.res.data);
    });
...
export const addStudentToGroup = (studentId, groupId, context) => dispatch => {
  context.setState({ spinnerMove: true });
  ...
  axios
    ...
    .then(res => {
      ...
      context.setState({ spinnerMove: false, success: true });
    })
    .catch(err => {
      console.log(err.res.data);
    });
...
export const sendStudentID = data => dispatch => {
  dispatch({
    type: STUDENT_ID,
    payload: data
  });
...
export const studentNotInGroup = (
  teacherId,
  requestStatus,
  groupId,
  context
  ...
  context.setState({ spinnerMove: true });
  axios
    .post(BASE_URL + "teacher/request/find-request-where-not-group", {
      teacher: teacherId,
      requestStatus: requestStatus,
      groupId: groupId
    })
